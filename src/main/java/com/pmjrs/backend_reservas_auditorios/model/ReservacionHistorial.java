...
public class ReservacionHistorial {
    ...
    private ReservacionStatus status;
    ...
    public ReservacionHistorial() {}

    public ReservacionHistorial(
            Reservacion reservacion,
            ReservacionStatus status,
    ...
    public ReservacionStatus getStatus() { return status; }
    public void setStatus(ReservacionStatus status) { this.status = status; }
