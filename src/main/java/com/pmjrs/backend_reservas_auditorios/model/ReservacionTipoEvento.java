...
public class ReservacionTipoEvento {
    ...
    public ReservacionTipoEvento() {}

    public ReservacionTipoEvento(String nombreTipoEvento, String descripcionTipoEvento, Integer activo, Integer creadoPor, LocalDate creadoEl, Integer actualizadoPor, LocalDate actualizadoEl) {
