...
public class Recursos {
    ...
    public Recursos(RecursosCatalogo recurso_catalogo, RecursosArea area, Integer activo,
    ...
    public RecursosArea getArea() { return area; }
    public void setArea(RecursosArea area) { this.area = area; }
